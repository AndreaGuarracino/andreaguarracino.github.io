...
\begin{tabular}{p{5cm}l}  % column alignment r=right l=left c=center
  ...
  Publications & {\bf 41} peer reviewed + {\bf 11} preprints = {\bf 52} total ({\bf 10} first or last)~\href{http://www.ncbi.nlm.nih.gov/pubmed/?term=Andrea+Guarracino[Author]}{\ding{234}} \\
...
% \begin{enumerate}
\input{includes/future_publications.tex}
% \end{enumerate}
...
\begin{tabular}{p{2cm}p{12.3cm}}  % column alignment r=right l=left c=center
  ...
  2026--- & Doctoral committee member of PhD student Shuo Cao, University of Tennessee Health Science Center (Memphis, USA), "Comparative and conservation analysis across 581 vertebrate genomes" \\

  2026--- & External doctoral committee member of PhD student Graciela Monfort Anez, Graduate School of the Stowers Institute for Medical Research (Kansas City, USA) \\

  2023--- & External advisor of PhD student Giada Sancamillo, SEMM European School of Molecular Medicine (Italy), "Dissecting the intracellular response to replication and mitotic stress in colorectal cancer for the design of novel effective (immuno)therapies" \\
