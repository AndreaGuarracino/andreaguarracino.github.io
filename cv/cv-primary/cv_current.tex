...
\begin{tabular}{p{5cm}l}  % column alignment r=right l=left c=center
  ...
  Publications & {\bf 40} peer reviewed + {\bf 11} preprints = {\bf 51} total ({\bf 10} first or last)~\href{http://www.ncbi.nlm.nih.gov/pubmed/?term=Andrea+Guarracino[Author]}{\ding{234}} \\
