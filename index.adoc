...
| `4 May 2026 to Present` +
| Doctoral committee member, PhD program, University of Tennessee Health Science Center (Memphis, USA)
| Comparative and conservation analysis across 581 vertebrate genomes
| -

| `3 Mar. 2026 to Present` +
| External doctoral committee member, PhD program, Graduate School of the Stowers Institute for Medical Research (Kansas City, USA)
| -
| -

| `1 Oct. 2023 to Present` +
| External advisor, PhD program in Systems Medicine, Computational Biology curricula, {university-semm} (Italy)
...
| Pangenome alignment, explicit and implicit pangenome graph building, subtelomeric interchromosomal rearrangements
| icon:spinner[] https://doi.org/10.64898/2026.07.21.739710[Preprint]
...
| **Genome Biology, 2026**
| pass:[*]**COSIGT: population-scalable genotyping of complex loci from low-coverage sequencing data using pangenome graphs**
| **Software development, evaluations, manuscript writing**
| icon:book[] https://doi.org/10.1186/s13059-026-04242-4[Paper]
...
| icon:book[] https://doi.org/10.1016/j.cell.2026.06.016[Paper]
