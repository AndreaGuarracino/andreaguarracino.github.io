...
:uri-graph-summit-2025-invitation: https://github.com/AndreaGuarracino/andreaguarracino.github.io/blob/main/other/20250227_GS_InvitationLetterDBCLS_Andrea Guarracino.pdf
...
| icon:book[] {uri-hugo2025-summary}[Website]
...
| icon:spinner[] {uri-li2025}[Preprint]
